...
import com.callor.hello01.ui.login.LoginActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
            res.layout.activity_main.xml 파일을 읽어서(열어서) 시작화면(현재클래스가 작동되는 화면)을 만들어라
         */
        ...
        */
        ...
        // click event를 처리할 EventHandler 선언
        // interface를 사용하여 직접 객체를 생성하는 방법
        // 전통 자바에서는 interface를 implement한 class 작성하고 class를 사용하여 객체를 선언(생성, 초기화)하엿는데
...
//                    Intent intent = new Intent("android.intent.action.CALL", Uri.parse("010-7791-0284"));

                    // 전화걸기 화면 띄우기
                    Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:010-7791-0284"));
                    startActivity(intent);
        ...
        // 하나의 EventHandler를 생성하여 2개의 버튼에 동시에 적용하기
